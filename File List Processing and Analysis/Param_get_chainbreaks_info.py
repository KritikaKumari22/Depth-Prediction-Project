...
def find_missing_ints_starting_from_1(list_of_ints):
    ...
    missing_ints = [] 
    for x in range(min(list_of_ints),max(list_of_ints)+1):
...
Broken_file="Chainbreak_info_10-03.txt"
Broken_path="/scratch/madhu/kritika/Depth/Filtered_pdbs/cbrk_info/"
